...
export function Sidebar({ className, onClose }: SidebarProps) {
    ...
    const [expandedSections, setExpandedSections] = useState<string[]>(["academic-management"]);
    ...
    const adminLinks: NavItem[] = [
        ...
        },
        {
            ...
            children: [
                ...
                { href: "/dashboard/admin/academic/ip-management", label: "IP Management" },
            ]
        },
    ...
    const renderNavItem = (item: NavItem) => {
        ...
        if (item.children) {
            ...
            const isExpanded = expandedSections.includes(sectionId) || isChildActive(item.children);
    ...
    return (
        <div className={cn("h-full bg-[#344e41] text-white flex flex-col", className)}>
