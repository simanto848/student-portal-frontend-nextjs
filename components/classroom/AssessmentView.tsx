                                ...
                                {assessments.length > 0 ? (
                                    assessments.map((assessment) => (
                                        <TableRow key={assessment.id}>
                                            ...
                                            <TableCell>
                                                <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${assessment.status === 'published' ? 'bg-green-100 text-green-800' :
                                            ...
                                            <TableCell>{assessment.dueDate ? format(new Date(assessment.dueDate), "MMM d, yyyy") : "-"}</TableCell>
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-2">
                                                    {assessment.status === 'draft' && (
                                                        <Button variant="ghost" size="icon" onClick={() => handlePublish(assessment.id)} title="Publish">
