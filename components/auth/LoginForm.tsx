            ...
            >
                ...
                <main className="flex w-full flex-col gap-8">
                    <div className="flex flex-col gap-3">
                        <p className="text-text-light dark:text-text-dark text-4xl font-black leading-tight tracking-[-0.033em]">{capitalize(role)} Login</p>
                        <p className="text-accent-light dark:text-accent-dark text-base">Please enter your {role} credentials to continue.</p>
                    </div>

                    <div className="flex w-full flex-col gap-4">
                        <label className="flex flex-col gap-2">
                            <p className="text-text-light dark:text-text-dark text-sm font-medium leading-normal">Email / ID</p>
                            <Input
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            />
                            <Link className="text-primary dark:text-accent-dark text-sm font-medium leading-normal self-end hover:underline" href={`/forgot-password/${role}`}>Forgot Password?</Link>
                        </div>
                        <Button
