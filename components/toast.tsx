...
const getToastStyle = (type: ToastType) => {
    const baseStyle = "relative pr-10! flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg";
...
export const notifyErrorResponse = (errorResponse: any) => {
    const message = get(errorResponse, "data.message") || get(errorResponse, "message") || "An error occurred";
    notify(message, "error");
};

export const notifySuccessResponse = (successResponse: any) => {
    const message = get(successResponse, "message") || get(successResponse, "message") || "Successful";
