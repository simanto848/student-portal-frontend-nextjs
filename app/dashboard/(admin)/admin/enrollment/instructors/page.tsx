...
export default function InstructorsPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [assignmentsData, teachersData, coursesData, batchesData] =
        await Promise.all([
                      ...
                      <TableRow key={assignment.id}>
                        <TableCell className="font-medium">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {getTeacherEmail(assignment.instructorId)}
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/dashboard/admin/enrollment/instructors/${assignment.id}`
                              )
                            }
                          >
                          ...
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/dashboard/admin/enrollment/instructors/${assignment.id}/edit`
                              )
                            }
                          >
