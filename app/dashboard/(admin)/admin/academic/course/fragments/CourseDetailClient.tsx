        ...
        >
            ...
            <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <Badge className={`px-2.5 py-1 rounded-lg text-xs font-bold ring-1 ring-inset ${course.isElective
                ...
                >
                    ...
                    <div className="bg-amber-50/50 border border-amber-100 rounded-2xl p-6 min-h-[160px]">
