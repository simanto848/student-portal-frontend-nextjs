                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-[#a3b18a]/20 p-6">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-lg font-semibold text-[#344e41]">Course Information</h2>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-base font-medium text-[#344e41]">{course.code}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-[#344e41]/70">Credits</label>
                                    <p className="text-base font-medium text-[#344e41]">{course.credit}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-[#344e41]/70">Type</label>
                                    <p className="text-base font-medium text-[#344e41] capitalize">{course.courseType}</p>
                                </div>
                                <div>
                                    <label className="text-sm font-medium text-[#344e41]/70">Elective</label>
                                    <p className="text-base font-medium text-[#344e41]">{course.isElective ? "Yes" : "No"}</p>
                                </div>
                                <div className="col-span-2">
                                    <label className="text-sm font-medium text-[#344e41]/70">Department</label>
                                    <p className="text-base font-medium text-[#344e41]">{getDepartmentName(course)}</p>
                                </div>
                                <div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-[#a3b18a]/20 p-6">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-lg font-semibold text-[#344e41]">Description</h2>
                        </div>
