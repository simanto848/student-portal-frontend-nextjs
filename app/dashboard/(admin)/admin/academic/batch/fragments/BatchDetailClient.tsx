        ...
        <DashboardLayout>
            <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-6 hover:shadow-md transition-shadow">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-1 px-3 py-2 rounded-xl bg-slate-50/50 border border-slate-100">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-2 px-3 py-2 rounded-xl bg-slate-50/50 border border-slate-100">
                                    <User className="h-4 w-4 text-slate-400" />
                                    <div>
                                        <p className="text-sm font-bold text-slate-900">
                ...
                <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
                    <DialogContent className="sm:max-w-[425px] bg-white border-slate-200 p-0 overflow-hidden rounded-2xl shadow-2xl">
