        ...
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Program Info Card */}
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200/60 space-y-6 col-span-2 hover:shadow-md transition-shadow">
                        ...
                        {program.description && (
                            <div className="mt-4 pt-4 border-t border-slate-50">
                                ...
                                <p className="text-sm text-slate-600 leading-relaxed bg-slate-50/50 p-4 rounded-xl border border-slate-100 italic">{program.description}</p>
                            </div>
                        )}
                    </div>

                    {/* Stats Card */}
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200/60 space-y-6 hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                            <div className="p-2 bg-amber-50 rounded-lg ring-1 ring-amber-100">
                        ...
                        <div className="space-y-4 pt-1">
                            <div className="bg-amber-50/50 border border-amber-100 p-4 rounded-xl text-center">
                                ...
                                <p className="text-[10px] text-amber-600/70 font-bold uppercase tracking-widest mt-1">Active Batches</p>
                            </div>
                            ...
                            <div className={`p-4 rounded-xl text-center border ring-1 ring-inset ${program.status
                                ...
                                <p className="text-[10px] font-bold uppercase tracking-widest mt-1 opacity-70">Program Status</p>
                            </div>
                        </div>
                    </div>
                </div>
