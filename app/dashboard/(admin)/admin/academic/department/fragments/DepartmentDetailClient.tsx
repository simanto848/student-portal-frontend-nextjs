        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <h1 className="text-2xl font-bold text-slate-900 tracking-tight">{department.name}</h1>
                    <p className="text-slate-500 font-medium">Department Details and Programs</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-white rounded-2xl shadow-sm border border-amber-100/60 p-6 hover:shadow-md transition-shadow">
