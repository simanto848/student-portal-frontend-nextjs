    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                {/* Basic Info Card */}
                <div className="bg-white rounded-2xl shadow-sm border border-amber-100/60 p-6 hover:shadow-md transition-shadow flex flex-col justify-between">
                    <div>
                        <div className="flex items-center gap-3 mb-6 border-b border-amber-100 pb-3">
