        ...
        <div className="space-y-10 pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <h1 className="text-5xl font-black tracking-tighter text-slate-900 leading-none">Admin Management</h1>
                    <p className="text-slate-500 font-bold mt-3 text-lg">Manage university administrators and their access permissions.</p>
                </div>
