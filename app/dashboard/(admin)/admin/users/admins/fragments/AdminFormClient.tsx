                        ...
                        {step === 1 && (
                            <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
                                    ...
                                    <FormGroup label="Registration ID" icon={Network}>
                        ...
                        {step === 3 && (
                            <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <FormGroup label="Gender" icon={Shield}>
                                ...
                                <FormGroup label="Profile Picture" icon={Sparkles}>
                                    ...
                                    />
                                    {profilePicture && <p className="mt-2 text-[10px] font-black text-amber-600 uppercase">Uploading: {profilePicture.name}</p>}
                                </FormGroup>
                            </motion.div>
                        )}
