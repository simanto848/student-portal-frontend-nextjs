    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (result.success) {
                ...
                router.push("/dashboard/moderator/users/staff");
            } else {
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            <Badge className="bg-amber-100 text-amber-700 border-none px-3 py-1 rounded-full flex items-center gap-2 shadow-sm">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest">{roleLabel[staff.role]}</span>
                            </Badge>
                            <span className="text-slate-300 font-black text-xs uppercase tracking-widest">ID: {staff.registrationNumber}</span>
                        </div>
                        <h1 className="text-4xl font-black tracking-tighter text-slate-900 leading-none">{staff.fullName}</h1>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        disabled={isDeleting}
                        className="h-14 px-6 rounded-2xl border-2 border-red-100 text-red-600 hover:bg-red-50 font-black tracking-tight"
                    >
                        <Trash2 className="w-5 h-5 mr-2" />
                        Deactivate
                    </Button>
                    <Button
                        onClick={() => router.push(`/dashboard/moderator/users/staff/${staff.id}/edit`)}
                                ...
                                <CardContent className="p-10">
                                    <div className="flex items-center gap-4 mb-10">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-500 font-bold text-sm italic">Detailed information and contact metadata.</p>
                                        </div>
                                    </div>
                    ...
                    <Card className="bg-slate-900 text-white border-none rounded-[3rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                        ...
                        <CardContent className="p-10 relative z-10">
                            <div className="flex items-center justify-between mb-8">
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">System Status</p>
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-12 bg-white/5 p-6 rounded-[2rem] backdrop-blur-md">
                                <div>
                                    <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1">Registration Date</p>
                                    <p className="text-[10px] font-black">{new Date(staff.createdAt || "").toLocaleDateString()}</p>
                                </div>
                                <div>
                                    <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest mb-1">Infrastructure</p>
                                    <p className="text-[10px] font-black">Portal Core</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-10">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 font-bold text-[10px] uppercase tracking-widest">Allowed Entry Points</p>
                                </div>
                            </div>
                                ...
                                <div className="flex flex-wrap gap-2 min-h-[50px]">
                                    {staff.registeredIpAddress && staff.registeredIpAddress.length > 0 ? (
                                        ...
                                        <div className="w-full py-8 text-center bg-slate-50 rounded-[2rem] border-2 border-dashed border-slate-100 flex flex-col items-center gap-2">
                                            ...
                                            <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest leading-none">Global Access Permitted</p>
                                        </div>
                                    )}
                                </div>
                            </div>
