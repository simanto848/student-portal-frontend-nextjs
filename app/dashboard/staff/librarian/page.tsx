  ...
  const quickActions = [
    {
      ...
      icon: Library,
      href: "/dashboard/staff/librarian/libraries",
    ...
    },
    {
      ...
      icon: BookOpen,
      href: "/dashboard/staff/librarian/books",
      count: stats.books,
      color: "bg-blue-500",
    },
    {
      ...
      icon: BookOpen,
      href: "/dashboard/staff/librarian/copies",
      count: stats.copies,
      color: "bg-green-500",
    },
    {
      ...
      icon: Users,
      href: "/dashboard/staff/librarian/borrowings",
    ...
    },
    {
      ...
      icon: Clock,
      href: "/dashboard/staff/librarian/reservations?status=pending",
