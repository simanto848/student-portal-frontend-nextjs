...
export default function ProgramControllerCoursePage() {
  ...
  const columns: Column<Course>[] = [
    ...
    },
    {
      ...
      cell: (item) => <span className="capitalize">{item.courseType}</span>,
    },
    {
      header: "Department",
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          ...
          subtitle="Manage academic courses for your department"
        ...
        {isLoading ? (
          ...
          <DataTable
            ...
            onView={(item) =>
              router.push(
                `/dashboard/staff/program-controller/courses/${item.id}`
              )
            }
            onEdit={handleEdit}
