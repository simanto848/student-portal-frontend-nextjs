...
const getId = (item: NamedItem | string | null | undefined): string => {
  if (!item) return "";
...
export default function ProgramControllerClassroomPage() {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          ...
          subtitle="Manage classrooms and facilities for your department"
          ...
          <DataTable
            data={classrooms.map((c) => ({
              ...
              departmentName: c.departmentId
                ? (c.departmentId as { name?: string }).name || "N/A"
                : "N/A",
            }))}
            columns={columns}
            ...
            onView={(item) =>
              router.push(
                `/dashboard/staff/program-controller/classrooms/${item.id}`
              )
            }
            onEdit={handleEdit}
          ...
          initialData={
            selectedClassroom
              ? {
                ...
                isUnderMaintenance:
                  selectedClassroom.isUnderMaintenance.toString(),
