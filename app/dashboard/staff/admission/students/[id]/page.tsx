...
export default function StaffStudentDetailsPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            router.push("/dashboard/staff/admission/students");
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <PageHeader
                        ...
                        icon={Users}
                        actionLabel="Edit"
                        onAction={() => router.push(`/dashboard/staff/admission/students/${id}/edit`)}
                    />
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <Card className="border-[#a3b18a]/30">
                        <CardContent className="p-6 space-y-4">
                            ...
                            <Button className="w-full justify-start" variant="outline" onClick={() => router.push(`/dashboard/staff/admission/students/${id}/edit`)}>
