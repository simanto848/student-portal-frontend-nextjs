    ...
    >
      <GlassCard className="p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h3 className="text-lg font-black text-slate-800 tracking-tight">General Appearance</h3>
            <p className="text-xs font-bold text-slate-400">Customize your portal experience</p>
          </div>
        </div>

        <div className="space-y-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between p-4 rounded-2xl bg-slate-50/50 border border-slate-100/50 hover:border-[#0088A9]/20 transition-all group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <Label className="text-sm font-black text-slate-800">Interface Theme</Label>
                <p className="text-[10px] font-bold text-slate-400">Select your preferred lighting</p>
              </div>
            </div>
            <div className="w-[180px]">
              <Select defaultValue="system">
                <SelectTrigger className="h-10 rounded-xl bg-white border-slate-100 font-bold text-slate-700 focus:ring-[#0088A9]/20">
      ...
      <GlassCard className="p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h3 className="text-lg font-black text-slate-800 tracking-tight">Transmission Rules</h3>
            <p className="text-xs font-bold text-slate-400">Manage communication channels</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50/50 border border-slate-100/50 hover:border-[#0088A9]/20 transition-all group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <Label className="text-sm font-black text-slate-800">Email Updates</Label>
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50/50 border border-slate-100/50 opacity-60 group">
            <div className="flex items-center gap-4">
              <div className="p-2 rounded-xl bg-white shadow-sm border border-slate-100">
                <Smartphone className="h-4 w-4 text-slate-300" />
              </div>
              <div>
                <Label className="text-sm font-black text-slate-500">SMS Notifications</Label>
