          ...
          <GlassCard className="p-8 h-full dark:bg-slate-900/60">
            ...
            <div className="space-y-6">
              ...
              <Button
                ...
                className="w-full h-12 rounded-xl bg-[#0088A9] hover:bg-[#007A99] text-white font-black tracking-tight shadow-xl shadow-[#0088A9]/10 transition-all active:scale-95"
              >
            ...
            {isLoadingSessions ? (
              ...
              sessions.map((session) => (
                <div key={session.id} className="p-5 rounded-2xl bg-white border border-slate-100 hover:border-[#0088A9]/30 transition-all group dark:bg-slate-900/50 dark:border-white/10">
                  <div className="flex items-center gap-4">
                    <div className="h-10 w-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center dark:bg-slate-800 dark:border-white/10">
                      {session.device.deviceType === 'mobile' ? (
                        ...
                        <Tablet className="h-5 w-5 text-slate-400 group-hover:text-[#0088A9] transition-colors" />
                      ) : (
                        <Laptop className="h-5 w-5 text-slate-400 group-hover:text-[#0088A9] transition-colors" />
                      )}
                    </div>
                    <div>
                  ...
                  {session.isCurrent && (
                    <Badge className="bg-[#0088A9]/10 text-[#0088A9] hover:bg-[#0088A9]/10 border-[#0088A9]/20 px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-tighter mr-2">
                      Current
                    </Badge>
                  )}
                  <Button
                    ...
                    className="h-8 px-3 text-rose-600 hover:text-rose-700 hover:bg-rose-50 rounded-lg text-[10px] font-black uppercase tracking-widest"
                  >
                    {session.isCurrent ? "Terminate" : "Revoke"}
                  </Button>
                </div>
              ))
            )}
