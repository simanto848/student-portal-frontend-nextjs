    ...
    try {
      ...
      if (enrollmentData) {
        const [studentData, courseData, batchData] = await Promise.all([
          ...
          courseService
            .getCourseById(enrollmentData.courseId)
            .catch(() => null),
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() =>
                router.push(
                  `/dashboard/admin/enrollment/enrollments/${id}/edit`
                )
              }
            >
                ...
                <>
                  ...
                  <div className="grid grid-cols-[120px_1fr] gap-2">
                    <span className="text-sm font-medium text-muted-foreground flex items-center gap-1">
                      <GraduationCap className="h-3 w-3" /> Reg No:
                    </span>
                    <span className="text-sm font-mono bg-gray-100 px-2 py-0.5 rounded w-fit">
