                    ...
                    <TabsContent value="academic" className="mt-6">
                        <Card className="border-[#a3b18a]/30">
                            ...
                            <CardContent className="grid gap-6 md:grid-cols-2">
                                ...
                                <InfoRow icon={Users} label="Batch" value={getName(batches, student.batchId)} />
                        ...
                        <Card className="border-[#a3b18a]/30">
                            ...
                            <CardContent className="grid gap-6 md:grid-cols-2">
                                {profile ? (
                                    ...
                                    <div className="col-span-2 text-center py-8 text-[#344e41]/60">No personal information available.</div>
                                )}
                            </CardContent>
                        </Card>
                    </TabsContent>
                            ...
                            <Card className="border-[#a3b18a]/30">
                                ...
                                <CardContent className="space-y-4">
                                    {profile?.permanentAddress ? (
                                        ...
                                        <div className="text-center py-4 text-[#344e41]/60">No address details.</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-[#a3b18a]/30">
                                ...
                                <CardContent className="space-y-6">
                                    {profile ? (
                                        ...
                                        <div className="text-center py-4 text-[#344e41]/60">No guardian details.</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-[#a3b18a]/30">
                                ...
                                <CardContent className="space-y-4">
                                    {profile?.emergencyContact ? (
                                        ...
                                        <div className="text-center py-4 text-[#344e41]/60">No emergency contact details.</div>
                                    )}
                                </CardContent>
                            </Card>
                        </div>
