...
import { GraduationCap, ChevronRight, ChevronLeft, CheckCircle2, Network, User, MapPin, Loader2, ArrowLeft } from "lucide-react";
        ...
        <Card className="border-[#a3b18a]/30">
          <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-[#588157]/10 to-[#a3b18a]/10 p-4 rounded-lg border-l-4 border-[#588157]">
                  <p className="text-sm text-[#344e41] font-medium">
                    <span className="text-[#588157] font-semibold">Step 1:</span> Please provide the basic information for the new teacher.
                  </p>
                </div>
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#344e41]">Full Name <span className="text-red-500">*</span></label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#344e41]">Email <span className="text-red-500">*</span></label>
                    <Input
                      type="email"
                      value={basic.email}
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#344e41] flex items-center justify-between">
                      ...
                      {loadingDepartments && <Loader2 className="h-4 w-4 animate-spin text-[#588157]" />}
                    </label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#344e41]">Designation</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#344e41]">Phone</label>
                    <Input
                      value={basic.phone}
              ...
              <div className="space-y-6">
                <div className="grid gap-5 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input type="date" value={advanced.joiningDate} onChange={e => updateAdvanced("joiningDate", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" />
                  </div>
                  <div className="space-y-2">
            ...
            {step === 3 && useProfile && (
              <div className="space-y-6">
                <div className="grid gap-5 md:grid-cols-2">
                  <div className="space-y-2"><label className="text-sm font-medium text-[#344e41]">First Name</label><Input value={profile.firstName} onChange={e => updateProfile("firstName", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" /></div>
                  <div className="space-y-2"><label className="text-sm font-medium text-[#344e41]">Last Name</label><Input value={profile.lastName} onChange={e => updateProfile("lastName", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" /></div>
                  <div className="space-y-2"><label className="text-sm font-medium text-[#344e41]">Middle Name</label><Input value={profile.middleName} onChange={e => updateProfile("middleName", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" /></div>
                  <div className="space-y-2"><label className="text-sm font-medium text-[#344e41]">Phone Number</label><Input value={profile.phoneNumber} onChange={e => updateProfile("phoneNumber", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" /></div>
                  <div className="space-y-2"><label className="text-sm font-medium text-[#344e41]">Date of Birth</label><Input type="date" value={profile.dateOfBirth} onChange={e => updateProfile("dateOfBirth", e.target.value)} className="bg-white border-[#a3b18a]/60 text-[#344e41]" /></div>
                  <div className="space-y-2">
            ...
            {step === 5 && (
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-[#588157]/10 to-[#a3b18a]/10 p-4 rounded-lg border-l-4 border-[#588157]">
                  <p className="text-sm text-[#344e41] font-medium">
                    <span className="text-[#588157] font-semibold">Review:</span> Please review all information before submitting.
                  </p>
                </div>
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    <div className="p-5 bg-gradient-to-br from-white to-[#dad7cd]/20 rounded-lg border-2 border-[#a3b18a]/30 shadow-sm space-y-2 text-sm text-[#344e41]">
                      ...
                      <div className="flex justify-between py-2 border-b border-[#a3b18a]/20">
                        <span className="font-medium text-[#344e41]/70">Email:</span>
                      ...
                      {basic.designation && (
                        <div className="flex justify-between py-2 border-b border-[#a3b18a]/20">
                          ...
                          <Badge className="bg-[#588157] text-white">{designationLabels[basic.designation]}</Badge>
                        </div>
                      )}
                      <div className="flex justify-between py-2 border-b border-[#a3b18a]/20">
                        <span className="font-medium text-[#344e41]/70">Registration:</span>
                        <span className="font-mono text-xs bg-[#dad7cd] px-2 py-1 rounded">{basic.registrationNumber}</span>
                      </div>
                      {basic.phone && (
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-5 bg-gradient-to-br from-white to-[#dad7cd]/20 rounded-lg border-2 border-[#a3b18a]/30 shadow-sm space-y-2 text-sm text-[#344e41]">
                        <div className="flex justify-between py-2 border-b border-[#a3b18a]/20">
                          ...
                          <span className="font-semibold">{profile.firstName} {profile.middleName && profile.middleName + ' '} {profile.lastName}</span>
                        </div>
                        {profile.phoneNumber && (
                          <div className="flex justify-between py-2 border-b border-[#a3b18a]/20">
                            <span className="font-medium text-[#344e41]/70">Phone:</span>
