...
export function ViewMemberModal({ member, open, onClose }: ViewMemberModalProps) {
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label className="text-right text-muted-foreground">Teacher Name</Label>
                        <div className="col-span-3 font-medium">{member.teacher?.fullName || 'Unknown'}</div>
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    {member.teacher?.registrationNumber && (
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3">{member.teacher.registrationNumber}</div>
                        </div>
                    )}
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label className="text-right text-muted-foreground">Member ID</Label>
                        <div className="col-span-3 text-xs text-muted-foreground">{member.id}</div>
                    </div>
                </div>
            </DialogContent>
        </Dialog>
