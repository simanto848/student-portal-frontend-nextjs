            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-200 border-none px-3 py-1 rounded-full flex items-center gap-2 mb-2 sm:mb-4 w-fit shadow-sm">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">{scope === 'department' ? 'Department' : 'Faculty'} Teachers</span>
                    </Badge>
                    <h1 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tighter text-slate-900 leading-none">Faculty Management</h1>
                    <p className="text-slate-500 font-bold mt-2 md:mt-3 text-sm md:text-lg">Manage teachers in your {scope}.</p>
                </div>
