...
export default function QuizListPage() {
  ...
  const totalSubmissions = quizzes.reduce(
    (sum, q) => sum + (q.submittedCount || 0),
    0,
  );
  const totalQuestions = quizzes.reduce(
    (sum, q) => sum + (q.questionCount || 0),
    0,
  );
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <Button
              ...
              size="icon"
              onClick={() =>
                router.push(`/dashboard/teacher/classroom/${workspaceId}`)
              }
          ...
          <Link
            href={`/dashboard/teacher/classroom/${workspaceId}/quiz/create`}
          >
        ...
        {quizzes.length === 0 ? (
          <Card className="border-dashed border-2 bg-gradient-to-br from-gray-50 to-white">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <h3 className="text-xl font-semibold text-[#344e41] mb-2">
                No quizzes yet
              </h3>
                ...
                >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48">
                          <DropdownMenuItem
                            onClick={() =>
                              router.push(
                                `/dashboard/teacher/classroom/${workspaceId}/quiz/${quiz.id}`,
                              )
                            }
                          >
                  ...
                  <CardFooter className="pt-3 border-t bg-gray-50/50">
                    <div className="flex items-center justify-between w-full">
                      ...
                      <Link
                        href={`/dashboard/teacher/classroom/${workspaceId}/quiz/${quiz.id}`}
                      >
                        <Button
                          variant="ghost"
                          size="sm"
