    ...
    const fetchData = async () => {
        try {
            ...
            if (attemptResult.attempt.studentId) {
                try {
                    const studentData = await studentService.getById(attemptResult.attempt.studentId);
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-[#344e41]">
                                        {student?.fullName || `Student #${attempt.studentId.slice(-8)}`}
                                    </p>
                                    <p className="text-sm text-muted-foreground">
                                        {student?.registrationNumber && (
                                            <span className="mr-2">{student.registrationNumber} •</span>
                                        )}
