          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {workspace.courseName || workspace.courseId}
                {workspace.courseCode ? ` (${workspace.courseCode})` : ""}
                {" • "}
                {workspace.batchName || workspace.batchId}
              </p>
            </div>
          </div>
        </div>
                        ...
                        <CardContent className="p-4 flex gap-4">
                          ...
                          <div>
                            <p className="font-medium text-[#1a3d32]">
                              {item.actorName} posted a new {item.type}:{" "}
            ...
            {assignments.length === 0 && materials.length === 0 ? (
              <Card>
                <CardContent className="p-12 text-center text-muted-foreground">
                  ...
                  <h3 className="text-lg font-medium text-[#1a3d32] mb-2">
                    Classwork
                  </h3>
                  ...
                  >
                    <CardContent className="p-4 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-[#1a3d32]">
                          {assignment.title}
                        </h4>
                        <p className="text-xs text-muted-foreground">
                          Due{" "}
                      ...
                      students.map((stu) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 text-sm font-semibold">
                              {stu.fullName
                            ...
                            <div className="space-y-0.5">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Reg: {stu.registrationNumber || "N/A"}
                              </div>
                            </div>
                          </div>
                          <Button
          ...
          <TabsContent value="grades" className="mt-6">
            <Tabs defaultValue="assignments" className="w-full">
              <TabsList className="w-full grid grid-cols-2">
                ...
                <TabsTrigger value="course-grades">
                  Final Course Grades
                </TabsTrigger>
              </TabsList>
                    ...
                    {selectedAssignmentId ? (
                      ...
                      <Card>
                        <CardContent className="p-12 text-center text-muted-foreground">
                          ...
                          <p>
                            Choose an assignment from the list to view
