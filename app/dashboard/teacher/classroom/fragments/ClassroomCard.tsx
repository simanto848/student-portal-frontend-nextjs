            ...
            <Card className="glass-panel group relative overflow-hidden rounded-[2.5rem] transition-all border border-white/50 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:shadow-teal-500/10">
                    ...
                    <div className="flex justify-between items-start gap-4">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2 mb-2">
                                <Badge className="bg-[#2dd4bf]/10 text-[#2dd4bf] border-teal-100/20 px-2.5 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-wider">
                                    Active Room
                                </Badge>
                                {workspace.courseCode && (
                                    <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest bg-slate-50 dark:bg-slate-800/50 px-2 py-0.5 rounded-md">
                                        {workspace.courseCode}
                                    </span>
                                )}
                            </div>
                ...
                <CardContent className="py-2 relative z-10">
                    <div className="flex items-center gap-6">
                        <div className="space-y-1">
                            <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none">Total Students</p>
                        ...
                        <div className="space-y-1">
                            <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none">Stream Status</p>
                ...
                <CardFooter className="pt-6 pb-8 relative z-10">
                    <Button
                        className="w-full h-14 rounded-2xl bg-[#2dd4bf] hover:bg-[#26b8a5] text-white font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-3 shadow-lg shadow-teal-500/20 transition-all active:scale-95 group/btn"
