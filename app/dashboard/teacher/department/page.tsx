        ...
        <DashboardLayout>
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-[#344e41]">Department Batches</h1>
                        <p className="text-[#344e41]/70">{department?.name || "Loading..."}</p>
                    </div>
                </div>
                                ...
                                {isLoading ? (
                                    ...
                                    filteredBatches.map((batch) => (
                                        <TableRow key={batch.id}>
                                            ...
                                            <TableCell>{batch.currentStudents}/{batch.maxStudents}</TableCell>
                                            <TableCell>
                                                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${batch.status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                    }`}>
