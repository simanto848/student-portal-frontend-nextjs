            ...
            <main className="w-full max-w-md">
                ...
                <Card className="rounded-xl border-border-light/30 dark:border-border-dark bg-white dark:bg-card-dark p-8">
                    <div className="text-center mb-8">
                        <h1 className="text-[28px] font-bold leading-tight tracking-tight text-primary-dark dark:text-text-dark">Reset Your Password</h1>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <Button type="submit" className="w-full h-12 rounded-lg bg-primary-dark dark:bg-primary text-base font-bold hover:bg-primary dark:hover:bg-primary-dark">Send OTP</Button>
                    </form>

                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600 dark:text-subtext-dark">
                            Remember your password?{" "}
                            <Link className="font-bold text-primary-dark dark:text-primary hover:underline" href="/login">
                                Back to Login
                            </Link>
                        </p>
                    </div>
