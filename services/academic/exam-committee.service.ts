...
export const examCommitteeService = {
    getMembers: async (departmentId?: string, batchId?: string): Promise<ExamCommittee[]> => {
        try {
            const params: any = {};
    ...
    addMember: async (data: { departmentId: string; teacherId: string; batchId?: string }): Promise<ExamCommittee> => {
        try {
    ...
    updateMember: async (id: string, data: Partial<ExamCommittee>): Promise<ExamCommittee> => {
        try {
